...
import "../../src/examples/EulerVaultBorrowable.sol";
...
contract EulerVaultBorrowableTest is DSTestPlus {
    ...
    function testMetadata(address conductorAddr, string calldata name, string calldata symbol) public {
        EulerVaultBorrowable vlt = new EulerVaultBorrowable(conductorAddr, underlying, name, symbol);
