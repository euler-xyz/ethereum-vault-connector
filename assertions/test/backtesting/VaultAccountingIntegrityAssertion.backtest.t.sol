...
contract VaultAccountingIntegrityAssertionBacktest is CredibleTestWithBacktesting {
    ...
    /// @notice Single transaction backtest for VaultAccountingIntegrityAssertion on Linea
    /// @dev Tests the batch accounting integrity assertion against a specific transaction
    function testBacktest_singleTx_lineaMainnet_VaultAccountingIntegrityAssertion() public {
        ...
        BacktestingTypes.BacktestingResults memory results = executeBacktestForTransaction(
            ...
            VaultAccountingIntegrityAssertion.assertionBatchAccountingIntegrity.selector,
            rpcUrl
        );
