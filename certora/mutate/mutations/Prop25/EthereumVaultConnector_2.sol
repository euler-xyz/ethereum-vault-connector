...
contract EthereumVaultConnector is Events, Errors, TransientStorage, IEVC {
    ...
    /// @inheritdoc IEVC
    function requireAccountStatusCheckNow(address account) public payable virtual 
        // [CERTORA MUTATE] Manual mutation, shouldn't be found.
        /*nonReentrantChecks*/ {
    ...
    function isSignerValid(address signer) internal pure returns (bool isValid) {
