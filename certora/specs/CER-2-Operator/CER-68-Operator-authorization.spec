...
hook Sstore EthereumVaultConnectorHarness.ownerLookup[KEY bytes19 prefix] address value {
    ownerLookupGhost[prefix] = value;
}
// makes sure that reads from ownerLookup after havocs are correct
hook Sload address value EthereumVaultConnectorHarness.ownerLookup[KEY bytes19 prefix] {
