...
rule onlyEVCCanCallCriticalMethod(method f, env e, calldataarg args) filtered {f -> !isMustRevertingFunction(f) && f.selector != sig:EthereumVaultConnectorHarness.permit(address,uint256,uint256,uint256,uint256,bytes,bytes).selector}{
